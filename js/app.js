...
function sumAndMultiply(a, b, c) { //eslint-disable-line
    const suma = sum(sum(a,b)[0],c)[0];
    const producto = multiply(multiply(a,b)[0],c)[0];
    const mensaje = a + " and " + b + " and " + c + " sum to " + suma + ".";
    const mensaje2 = "The product of " + a + " and " + b + " and " + c + " is " + producto + ".";
    return [suma,producto, mensaje, mensaje2];
}
